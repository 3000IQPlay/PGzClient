...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("909644500765405235", handlers, true, "");
        ...
        DiscordPresence.presence.smallImageKey = "small";
        DiscordPresence.presence.smallImageText = "BerryPGz";
        DiscordPresence.presence.largeImageText = "PGz Client";
        ...
        thread = new Thread(() -> {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (RPC.INSTANCE.catMode.getValue().booleanValue()) {
                    ...
                    DiscordPresence.presence.largeImageKey = "duck" + index;
                    ++index;
                }
                rpc.Discord_UpdatePresence(presence);
                try {
