...
class ModuleButton
    ...
    private final ResourceLocation logo = new ResourceLocation("textures/gears.png");
    ...
    void drawScreen ( int mouseX , int mouseY , float partialTicks ) {
        ...
        if ( ! this.items.isEmpty ( ) ) {
                if (ClickGui.getInstance().gears.getValue().booleanValue()) {
                    ...
                    ModuleButton.drawCompleteImage(this.x - 22f + (float) this.width - 7.4f + 16, this.y - 2.2f - (float) PhobosGui.getClickGui().getTextOffset() - 2, 11, 11);
                }
