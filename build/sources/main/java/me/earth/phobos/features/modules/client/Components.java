...
class Components
    ...
    public Setting < Boolean > imageLogo = this.register ( new Setting <> ( "ImageLogo" , true ) );
    ...
    public Setting < Integer > imageWidth = this.register ( new Setting < Object > ( "ImageWidth" , 24 , 0 , 1000 , v -> this.imageLogo.getValue ( ) ) );
    public Setting < Integer > imageHeight = this.register ( new Setting < Object > ( "ImageHeight" , 24 , 0 , 1000 , v -> this.imageLogo.getValue ( ) ) );
    ...
    public Setting < Boolean > clock = this.register ( new Setting <> ( "Clock" , false ) );
    public Setting < Boolean > clockFill = this.register ( new Setting <> ( "ClockFill" , false ) );
    ...
    void preboxrender ( ) {
        ...
        GlStateManager.color ( 40.0f , 160.0f , 0.0f , 255.0f );
    }
    ...
    public
    void drawPlayer ( EntityPlayer player ) {
        GlStateManager.pushMatrix ( );
    ...
    private
    void itemrender ( NonNullList < ItemStack > items , int x , int y ) {
        int iX;
        int i;
