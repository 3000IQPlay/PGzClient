...
class Colors
    ...
    public Setting < Integer > red = this.register ( new Setting < Object > ( "Red" , 40 , 0 , 255 , v -> ! this.rainbow.getValue ( ) ) );
    public Setting < Integer > green = this.register ( new Setting < Object > ( "Green" , 160 , 0 , 255 , v -> ! this.rainbow.getValue ( ) ) );
    public Setting < Integer > blue = this.register ( new Setting < Object > ( "Blue" , 0 , 0 , 255 , v -> ! this.rainbow.getValue ( ) ) );
    public Setting < Integer > alpha = this.register ( new Setting < Object > ( "Alpha" , 160 , 0 , 255 , v -> ! this.rainbow.getValue ( ) ) );
    public float hue;
