...
class GuiCustomMainScreen
    ...
    public static
    boolean isHovered ( int x , int y , int width , int height , int mouseX , int mouseY ) {
    ...
    public
    BufferedImage parseBackground ( BufferedImage background ) {
        int height;
        int width = 1920;
    ...
    class TextButton
            extends GuiButton {
        public
        TextButton ( int buttonId , int x , int y , String buttonText ) {
