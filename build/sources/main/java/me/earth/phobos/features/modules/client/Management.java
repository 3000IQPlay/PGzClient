...
class Management
    ...
    public Setting < String > command = this.register ( new Setting <> ( "Command" , "PGzClient" ) );
    public Setting < Boolean > rainbowPrefix = this.register ( new Setting <> ( "RainbowPrefix" , false ) );
    public Setting < TextUtil.Color > bracketColor = this.register ( new Setting <> ( "BColor" , TextUtil.Color.GREEN ) );
    public Setting < TextUtil.Color > commandColor = this.register ( new Setting <> ( "CColor" , TextUtil.Color.GREEN ) );
